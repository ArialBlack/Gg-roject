    ...
    grunt.initConfig({
        ...
        less: {
            development: {
                ...
                files: {
                    '../themes/ggproject_ui/css/style.css': '../themes/ggproject_ui/less/style.less'
                }
            }
        },
        ...
        watch: {
            ...
            bake: {
                files: [
                    '../themes/ggproject_ui/_templates-src/**/*.php'
                ],
                tasks: ['bake']
            }
        ...
        postcss: {
            ...
            dist: {
              src: '../themes/ggproject_ui/css/style.css'
            }
        }
    });
